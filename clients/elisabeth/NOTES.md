# Notes — Elisabeth, glass / double glass
...
| Use | Avoid |
|-----|--------|
| glass, back glass, double glass, corner | ice, iced, frozen, backboard |
| bounce, rebound, reset, rally | game-changer, unlock, elevate |
| vitre, double vitre, fond, coin, relance, échange | découvrez, révolutionnez, “glace” as ice |
...
`#padelfrance` `#défensevitre` `#doublevitre` `#padeltechnique`
